...
#Enter 1 to Train, Enter 0 to Recognize

#if training 
#than enter no of gestures you want to train, name of gestures, file name of triaining data 

#ardino.pkl has some trained gestures loaded -named (one,two,three,four,five,stop)
#re training a trained file will erase the previously trained data 

#arduino code is also attached in file named gesturedetection
#while running this code, please make sure that serial monitor is not open in arduino ide


#change port name according to device 
...
while True:
    ...
    if train == 0:
        if handData!=[]:
            ...
            myGesture=findGesture(unknownGesture,knownGestures,keyPoints,gestNames,tol)#name of recognized gesture 
